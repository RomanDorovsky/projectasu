...
const btns = document.getElementById('listener')
...
const renderResults = () => {
    btns.classList.add('btns-invisible')
    endTest.classList.add('end-test-visible')
    questionNumber.innerHTML = `<h2 class="question">Спасибо<br>за прохождение<br>тестирования!</h2>`
    questionText.innerHTML = `<p class="question-text">Пожалуйста, присоеденитесь к чату.</p>`
}
...
btnBack.addEventListener('click', (event, index) => {
    ...
    if(Number(questionNumber.dataset.currentStep) === 0){
